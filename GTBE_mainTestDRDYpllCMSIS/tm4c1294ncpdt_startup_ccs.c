...
void (* const g_pfnVectors[])(void) =
{
    ...
    DAC_uDMAsw_ISR,                      	// uDMA Software Transfer
    twe_uDMAErrorHandler,                   // uDMA Error
    ...
    ADC_SSIRXuDMA_ISR,                      // SSI2 Rx and Tx
    DAC_intHandlerSSI,                 		// SSI3 Rx and Tx
